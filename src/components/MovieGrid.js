...
const  MovieGrid = (props)=>  {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', alignSelf: "flex-start", }}>
      <View style={styles.buttonStack}>
        <TouchableOpacity style={styles.button}>
          ...
          <Text style={styles.shortFilm}>   {props.movie.category} : {props.movie.txt_movie_rating}</Text>
          <Text style={styles.bengali}>{props.movie.language}</Text>
          
          <Text style={styles.ticket19}>Price: Rs.{props.movie.num_movie_price_inr}/-</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  buttonStack: {
    ...
    width: 190,
    height: 320, padding: 8, marginTop:5,
